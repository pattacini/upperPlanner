...
#ifndef REACHINGSUPERVISORTHREAD_H
#define REACHINGSUPERVISORTHREAD_H
...
class reachingSupervisorThread : public RFModule
{
protected:
    string name;
...
#endif // REACHINGSUPERVISORTHREAD_H
